...
gp8(){return"Un dos teus dispositivos non est\xe1 verificado"},
goq(){return"Nota: Cando conectas todos os teus dispositivos \xe1 copia de apoio da conversa quedan verificados automaticamente."},
...
gpb(){return"Outros axustes das notificaci\xf3ns"},
gov(){return"Cont\xe9n nome de usuaria"},
gow(){return"Informa \xe1 usuaria cando unha mensaxe cont\xe9n o seu identificador."},
goJ(){return"Acalar todas as notificaci\xf3ns"},
goK(){return"Sobrescribe todas as outras regras e desactiva todas as notificaci\xf3ns."},
gp0(){return"Suprimir mensaxes automatizadas"},
gp5(){return"Suprime as notificaci\xf3ns desde clientes automatizados como os robots."},
goB(){return"Te\xf1o un convite"},
goC(){return"Informa \xe1 usuaria de que recibeu o convite para unha sala."},
goL(){return"Eventos dos participantes"},
goM(){return"Suprime as notificaci\xf3ns dos eventos de participaci\xf3n."},
goF(){return"Menci\xf3n da usuaria"},
goG(){return"Informa cando se menciona expl\xedcitamente a usuaria nunha mensaxe."},
got(){return"Cont\xe9n o nome p\xfablico"},
gou(){return"Informa \xe1 usuaria cando unha mensaxe cont\xe9n o seu nome p\xfablico."},
goD(){return"Menci\xf3n da sala"},
goE(){return"Informa \xe1 usuaria cando hai unha menci\xf3n da sala."},
goV(){return"Notificaci\xf3n da sala"},
goW(){return"Informa \xe1 usuaria cando unha mensaxe cont\xe9n '@room'."},
gp6(){return"L\xe1pida"},
gp7(){return"Informa \xe1 usuaria sobre a desactivaci\xf3n de mensaxes na sala."},
goP(){return"Reacci\xf3n"},
goQ(){return"Omite as notificaci\xf3ns sobre reacci\xf3ns."},
goT(){return"ACL da servidor da sala"},
goU(){return"Omite notificaci\xf3ns para as listas de control de acceso (ACL) do servidor da sala."},
goZ(){return"Omite edici\xf3ns"},
gp_(){return"Omite as notificaci\xf3ns sobre mensaxes editadas."},
gor(){return"Chamada"},
gos(){return"Informa \xe1 usuaria sobre as chamadas."},
goz(){return"Sala cifrada conversa persoal"},
goA(){return"Informa \xe1 usuaria sobre mensaxes cifradas en salas de conversa persoal."},
goR(){return"Sala de conversa persoal"},
goS(){return"Informa \xe1 usuaria sobre mensaxes en salas de conversa persoal."},
goN(){return"Mensaxe"},
goO(){return"Informa \xe1 usuaria sobre mensaxes xen\xe9ricas."},
gox(){return"Salas cifradas"},
goy(){return"Informa \xe1 usuaria sobre mensaxes en salas cifradas."},
goH(){return"Jitsi"},
goI(){return"Informa \xe1 usuaria sobre eventos do widget Jitsi."},
goX(){return"Omite eventos do sevidor ACL"},
goY(){return"Omite notificaci\xf3n sobre eventos do servidor ACL."},
...
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_245",e:"endPart",h:b})})($__dart_deferred_initializers__,"ydy5TvCZUvwbPYGnwevI64FqNMU=");
