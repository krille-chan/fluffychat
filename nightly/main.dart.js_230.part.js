...
go0(){return"Cambiar los ajustes generales de chat"},
goi(){return"Invitar a otros usuarios a este chat"},
go2(){return"Cambiar los permisos de chat"},
go4(){return"Cambiar la visibilidad de la historia de chat"},
go1(){return"Cambiar la direcci\xf3n p\xfablica principal de chat"},
gnH(){return"Mandar notificaci\xf3n @sala"},
go3(){return"Cambiar la descripci\xf3n del chat"},
go6(){return"Definir el nivel necesario para ciertas acciones en este chat. Los niveles 0, 50 y 100 habitualmente representan usuarios, moderadores y administradores, pero se puede establecer cualquier escala."},
ph(d){return"\xa1\ud83c\udf89 Actualizaci\xf3n "+d+" instalada!"},
go5(){return"Cambios"},
gnF(){return"Env\xedo cancelado"},
gol(){return"Entrar con un ID de Matrix"},
goe(){return"Descubrir homeservers"},
...
gof(){return"No parece ser un homeserver compatible. \xbfURL equivocada?"},
go_(){return"Calculando tama\xf1o de archivo..."},
...
go8(){return"Contactar con el administrador del servidor"},
go9(){return"Contactar con seguridad del servidor"},
...
gnO(){return"Tachado"},
gnA(){return"Por favor, rellenar"},
goh(){return"URL incorrecta"},
gnS(){return"A\xf1adir enlace"},
gnC(){return"No se puede entrar al chat. Puede que la otra parte ya haya cerrado la conversaci\xf3n."},
gjA(){return"Anterior"},
...
goa(){return"Ajustes de notificaci\xf3n de contenido"},
...
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_230",e:"endPart",h:b})})($__dart_deferred_initializers__,"Fw+BlbbIhEU05CDs23uLnO5/R7Q=");
