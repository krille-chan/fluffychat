...
gop(){return"Canvia els permisos de la sala"},
gor(){return"Canvia la visibilitat de l'historial de conversa"},
goo(){return"Canvia l'adre\xe7a principal de la sala"},
goa(){return"Envia notificacions @room"},
goq(){return"Canvia la descripci\xf3 de la sala"},
got(){return"Defineix quin nivell de permisos cal per cada acci\xf3 en aquesta sala. Els nivells 0, 50 i 100 normalment representen usu\xe0ri\xefs, mods i admins, per\xf2 es pot canviar."},
...
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_207",e:"endPart",h:b})})($__dart_deferred_initializers__,"/WzEzq0xHxtPFy6wadjDecJxVSg=");
