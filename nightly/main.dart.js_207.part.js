...
goq(){return"Canvia els permisos del xat"},
gos(){return"Canvia la visibilitat de l'historial de conversa"},
gop(){return"Canvia l'adre\xe7a principal del xat"},
gob(){return"Envia notificacions @room"},
gor(){return"Canvia la descripci\xf3 del xat"},
gou(){return"Defineix quin nivell de permisos cal per cada acci\xf3 en aquest xat. Els nivells 0, 50 i 100 normalment representen usu\xe0ri\xefs, mods i admins, per\xf2 es pot canviar."},
...
gon(){return"S'est\xe0 calculant la mida de l'arxiu..."},
goO(){return"S'est\xe0 preparant per enviar l'adjunt..."},
goc(){return"S'est\xe0 enviant l'adjunt..."},
od(d,e){return"S'est\xe0 enviant l'adjunt "+d+" de "+e+"..."},
of(d){return"S'ha arribat al l\xedmit del servidor! Esperant "+d+" segons..."},
goL(){return"Un dels teus dispositius no est\xe0 verificat"},
goK(){return"Nota: quan connectes tots els dispositius al backup del xat, es verifiquen autom\xe0ticament."},
goy(){return"Continua"},
...
gol(d){return"Difumina:"},
gcg(d){return"Opacitat:"},
gl1(){return"Tria imatge de fons"},
goI(){return"Gestiona el compte"},
go4(){return"El servidor no ofereix cap informaci\xf3 de contacte v\xe0lida"},
gow(){return"Contacta l'admin del servidor"},
gox(){return"Contacta l'equip de seguretat del servidor"},
goh(){return"P\xe0gina de suport"},
goe(){return"Informaci\xf3 del servidor:"},
gbD(d){return"Nom"},
goR(d){return"Versi\xf3"},
goS(){return"Lloc web"},
gov(){return"Comprimeix"},
gom(){return"Text en negreta"},
goF(){return"Text en cursiva"},
gog(){return"Text ratllat"},
goN(){return"Emplena"},
goD(){return"URL inv\xe0lida"},
goj(){return"Afegeix un enlla\xe7"},
go6(){return"No s'ha pogut entrar al xat. Pot ser que l'altri participant hagi tancat la conversa."},
C(d,e){return this.gbp(this).$1(e)}}
var z=a.updateTypes([]);(function inheritance(){var y=a.inherit
y(B.HJ,C.aR)})()
A.ep(b.typeUniverse,JSON.parse('{"HJ":{"aR":[]}}'))};
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_207",e:"endPart",h:b})})($__dart_deferred_initializers__,"JxXlhurb7tb6Uin5GN/RyoFn09k=");
