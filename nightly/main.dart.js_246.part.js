...
gof(){return"Non semella ser un servidor de inicio compatible. \xc9 o URL correcto?"},
...
goj(){return"Cursiva"},
gnO(){return"Riscar"},
gnA(){return"Por favor completa"},
goh(){return"URL non v\xe1lido"},
gnS(){return"Engadir ligaz\xf3n"},
gnC(){return"Non se puido acceder. Pode que a outra parte xa pechase a conversa."},
gjA(){return"Anterior"},
...
goa(){return"Axustes de notificaci\xf3n de contido"},
...
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_246",e:"endPart",h:b})})($__dart_deferred_initializers__,"oYFWERONQJlrBz/M1tgsVWqji/8=");
