...
gp8(){return"Un dels teus dispositius no est\xe0 verificat"},
goq(){return"Nota: quan connectes tots els dispositius al backup del xat, es verifiquen autom\xe0ticament."},
gnu(){return"Continua"},
...
gpb(){return"Altres opcions de notificacions"},
gov(){return"Cont\xe9 el nom d'usu\xe0ri\xef"},
gow(){return"Notifica l'usu\xe0ri\xef quan un missatge contingui el seu nom."},
goJ(){return"Silencia totes les notificacions"},
goK(){return"Ignora totes les altres regles i deshabilita totes les notificacions."},
gp0(){return"Elimina els missatges autom\xe0tics"},
gp5(){return"No envia notificacions relacionades amb usu\xe0ri\xefs autom\xe0tics com els bots."},
goB(){return"Invitaci\xf3 per a mi"},
goC(){return"Notifica l'usu\xe0ri\xef quan \xe9s convidadi a una sala."},
goL(){return"Canvis de membres"},
goM(){return"Ignora les notificacions quan entra o surt alg\xfa d'una sala."},
goF(){return"Mencions"},
goG(){return"Notifica quan mencionin l'usu\xe0ri\xef en un missatge."},
got(){return"Cont\xe9 el nom visible"},
gou(){return"Notifica l'usu\xe0ri\xef quan un missatge contingui el seu nom per mostrar."},
goD(){return"Menci\xf3 de sala"},
goE(){return"Notifica l'usu\xe0ri\xef quan es s'esmenti la sala."},
goV(){return"Notificaci\xf3 de sala"},
goW(){return"Notifica l'usu\xe0ri\xef quan un missatge contingui '@room'."},
gp6(){return"L\xe0pida"},
gp7(){return"Notifica l'usu\xe0ri\xef dels missatges de desactivaci\xf3 de sales."},
goP(){return"Reacci\xf3"},
goQ(){return"Ignora les notificacions sobre reaccions."},
goT(){return"Regles ACL del servidor d'una sala"},
goU(){return"Ignora les notificacions sobre les regles d'acc\xe9s (ACL) del servidor d'una sala."},
goZ(){return"Elimina les edicions"},
gp_(){return"Ignora les notificacions per missatges editats."},
gor(){return"Trucada"},
gos(){return"Notifica l'usu\xe0ri\xef de trucades."},
goz(){return"Converses xifrades"},
goA(){return"Notifica l'usu\xe0ri\xef de missatges en sales xifrades un a un, converses de dues persones."},
goR(){return"Converses"},
goS(){return"Notifica l'usu\xe0ri\xef de missatges en converses de dues persones, sales un a un."},
goN(){return"Missatge"},
goO(){return"Notifica l'usu\xe0ri\xef sobre missatges generals."},
gox(){return"Xifrat"},
goy(){return"Notifica l'usu\xe0ri\xef de missatges en sales xifrades."},
goH(){return"Jitsi"},
goI(){return"Notifica l'usu\xe0ri\xef sobre activitat del giny de Jitsi."},
goX(){return"Ignora canvis en ACL de servidor"},
goY(){return"Ignora les notificacions per canvis en les regles d'acc\xe9s (ACL) de servidor."},
...
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_202",e:"endPart",h:b})})($__dart_deferred_initializers__,"mwFd+AJFOlnW8qPNaEPWQHQK7u4=");
