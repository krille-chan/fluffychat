...
geP(){return"Pridru\u017ei se lahko vsak"},
geQ(){return"Arhiv"},
...
gkf(){return"Space"},
gnl(){return"Spaces"},
geS(){return"Prepoved klepeta"},
geT(){return"Prepovedano"},
hb(d,e){return d+" je prepovedan v "+e},
ghd(){return"Blokirana naprava"},
gcl(){return"Blokirano"},
gbs(d){return"Prekli\u010di"},
eV(d){return"URI-ja "+d+" ni mogo\u010de odpreti"},
geX(){return"Spremenite ime naprave"},
...
geZ(){return"Spremenite svoj slog"},
geY(){return"Spremenite ime skupine"},
...
gf_(){return"Podrobnosti klepeta"},
gf0(){return"Klepeti"},
ghx(){return"Izberite mo\u010dno geslo"},
gf1(){return"Po\u010disti arhiv"},
gcj(d){return"Zapri"},
...
gf2(){return"Vsebina je bila prijavljena skrbnikom stre\u017enika"},
...
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_287",e:"endPart",h:b})})($__dart_deferred_initializers__,"bEBnzfkbe8t0Vo35qSFREgeq5SY=");
