...
gp8(){return"Uno dei tuoi dispositivi non \xe8 verificato"},
goq(){return"Nota: quando colleghi tutti i tuoi dispositivi al backup della chat, vengono verificati automaticamente."},
gnu(){return"Continua"},
...
gnN(){return"Barrato"},
gpc(){return"Si prega di compilare"},
...
gon(){return"\ud83d\udce9 Nuova richiesta di chat"},
...
gpb(){return"Altre impostazioni di notifica"},
gov(){return"Contiene il nome utente"},
gow(){return"Notifica l'utente quando un messaggio contiene il proprio nome utente."},
goJ(){return"Silenzia tutte le notifiche"},
goK(){return"Sovrascive tutte le altre regole e disabilita tutte le notifiche."},
gp0(){return"Silenziare i messaggi automatizzati"},
gp5(){return"Silenzia le notifiche da client automatizzati come i bot."},
goB(){return"Inviti per me"},
goC(){return"Notifica l'utente quando \xe8 invitato in una stanza."},
goL(){return"Eventi per i membri"},
goM(){return"Silenzia le notifiche per gli eventi dei membri."},
goF(){return"Menzioni dell'utente"},
goG(){return"Notifica l'utente quando viene menzionato direttamente in un messaggio."},
got(){return"Contiene nome visualizzato"},
gou(){return"Notifica l'utente quando un messaggio contiene il proprio nome visualizzato."},
goD(){return"Menzioni della stanza"},
goE(){return"Notifica l'utente quando c'\xe8 una menzione della stanza."},
goV(){return"Notifiche della stanza"},
goW(){return"Notifica l'utente quando un messaggio contiene '@room'."},
gp6(){return"Tombstone"},
gp7(){return"Notifica all'utente i messaggi di disattivazione della stanza."},
goP(){return"Reazioni"},
goQ(){return"Silenzia le notifiche per le reazioni."},
goT(){return"ACL del server della stanza"},
goU(){return"Silenzia le notifiche per gli elenchi di controllo degli accessi del server della stanza (ACL)."},
goZ(){return"Silenzia le modifiche"},
gp_(){return"Silenzia le notifiche per i messaggi modificati."},
gor(){return"Chiamate"},
gos(){return"Notifica all'utente le chiamate."},
goz(){return"Stanze crittografate One-to-One"},
goA(){return"Notifica all'utente i messaggi in stanze crittografate one-to-one."},
goR(){return"Stanze One-to-One"},
goS(){return"Notifica all'utente i messaggi nelle stanze one-to-one."},
goN(){return"Messaggi"},
goO(){return"Notifica all'utente i messaggi generali."},
gox(){return"Crittografate"},
goy(){return"Notifica all'utente i messaggi nelle stanze crittografate."},
goH(){return"Jitsi"},
goI(){return"Notifica all'utente gli eventi del widget Jitsi."},
goX(){return"Silenziare gli eventi ACL del server"},
goY(){return"Silenzia le notifiche per gli eventi ACL del server."},
...
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_267",e:"endPart",h:b})})($__dart_deferred_initializers__,"bd+a0PduCsQ/aR3jcaWz8VnmEww=");
