...
gp8(){return"Uno de tus dispositivos no est\xe1 verificado"},
goq(){return"Nota: Cuando conectas todos tus dispositivos a la copia de seguridad del chat, son verificados autom\xe1ticamente."},
...
gpb(){return"Otros ajustes de notificaci\xf3n"},
gov(){return"Contiene nombre de usuario"},
gow(){return"Notifica al usuario cuando un mensaje contiene su nombre de usuario."},
goJ(){return"Silenciar todas las notificaciones"},
goK(){return"Anula todas las dem\xe1s reglas y desactiva todas las notificaciones."},
gp0(){return"Suprimir los mensajes autom\xe1ticos"},
gp5(){return"Suprimir notificaciones de clientes autom\xe1ticos, como bots."},
goB(){return"Invitaci\xf3n para m\xed"},
goC(){return"Notifica al usuario cuando se les invita a una sala."},
goL(){return"Evento para miembros"},
goM(){return"Suprimir notificaciones de eventos para miembros."},
goF(){return"Menci\xf3n al usuario"},
goG(){return"Notifica al usuario cuando son mencionados directamente en un mensaje."},
got(){return"Contiene el nombre visible"},
gou(){return"Notifica al usuario cuando un mensaje contiene su nombre visible."},
goD(){return"Menci\xf3n de sala"},
goE(){return"Notifica al usuario cuando hay una menci\xf3n de sala."},
goV(){return"Notificaci\xf3n de sala"},
goW(){return"Notifica al usuario cuando un mensaje contiene '@sala'."},
gp6(){return"L\xe1pida"},
gp7(){return"Notifica al usuario sobre mensajes de desactivaci\xf3n de sala."},
goP(){return"Reacci\xf3n"},
goQ(){return"Suprime notificaciones por reacciones."},
goT(){return"ACL de servidor de sala"},
goU(){return"Suprime notificaciones de listas de control de acceso de servidores de sala."},
goZ(){return"Suprimir ediciones"},
gp_(){return"Suprime las notificaciones de mensajes editados."},
gor(){return"Llamar"},
gos(){return"Notifica al usuario de llamadas."},
goz(){return"Sala cifrada uno a uno"},
goA(){return"Notifica al usuario sobre mensajes en salas cifradas uno a uno."},
goR(){return"Sala uno a uno"},
goS(){return"Notifica al usuario sobre mensajes en salas uno a uno."},
goN(){return"Mensaje"},
goO(){return"Notifica al usuario sobre mensajes generales."},
gox(){return"Cifrado"},
goy(){return"Notifica al usuario sobre mensajes en salas cifradas."},
goH(){return"Jitsi"},
goI(){return"Notifica al usuario sobre eventos del componente de Jitsi."},
goX(){return"Suprimir eventos de ACL del servidor"},
goY(){return"Suprime notificaciones de eventos de ACL del servidor."},
...
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_229",e:"endPart",h:b})})($__dart_deferred_initializers__,"R9ajelVrIs/LlaXz8soElFGwzPU=");
