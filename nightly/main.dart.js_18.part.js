...
gpr(){return"Mais eventos"},
glC(){return"Rejeitar convite"},
gpt(){return"Nenhuma mensagem ainda"},
gpq(){return"Segure para gravar uma mensagem de voz."},
gjq(d){return"Pausar"},
...
gpv(){return"Quest\xe3o da enquete"},
...
gpp(){return"Carregando mensagens"},
goR(){return"Configurar backup de conversas"},
pC(d){return"Vers\xe3o: "+d},
gp0(){return""},
gpy(){return""},
A(d,e){return this.gb7(this).$1(e)}}
A.Gi.prototype={
...
x(A.Bg,C.aD)
w(A.Bg,[A.Gh,A.Gi])})()
B.dI(b.typeUniverse,JSON.parse('{"Bg":{"aD":[]},"Gh":{"aD":[]},"Gi":{"aD":[]}}'))
var y={h:" alterou a visibilidade do hist\xf3rico para: ",a:"(BETA) Ativar m\xfaltiplas contas neste dispositivo"}};
(a=>{a["ETN7xUjMD9l2s0n1hVckAXekCRc="]=a.current})($__dart_deferred_initializers__);
