  ...
  Widget build(BuildContext context) {
    ...
    return ViewModelBuilder(
      ...
      builder: (context, viewModel, _) {
        final mini = viewModel.value.mini;
                        ...
                        appBar: AppBar(
                          ...
                          actions: [
                            IconButton(
                              ...
                              onPressed: viewModel.toggleMini,
                            ),
                            if (localVideoTrack == null)
                              PopupMenuButton(
                                itemBuilder: (context) => [
                                  PopupMenuItem(
                                    onTap: () =>
                                        viewModel.selectCamera(context),
                                    child: Row(
                                      mainAxisSize: .min,
                                      spacing: 12,
                                      children: [
                                  ...
                                  PopupMenuItem(
                                    onTap: () =>
                                        viewModel.selectMicrophone(context),
                                    child: Row(
                                      mainAxisSize: .min,
                                      spacing: 12,
                                      children: [
                                  ...
                                  PopupMenuItem(
                                    onTap: () =>
                                        viewModel.selectSpeaker(context),
                                    child: Row(
                                      mainAxisSize: .min,
                                      spacing: 12,
                                      children: [
                            ...
                            : SafeArea(
                                ...
                                child: LayoutBuilder(
                                  builder: (context, constraints) {
                                    ...
                                    final tiles = liveKitRoom.getCallTiles(
                                      room,
                                    );
