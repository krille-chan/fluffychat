  ...
  void startSearch() async {
    switch (tabController.index) {
      case 0:
        ...
        print('Start search with batch $messagesNextBatch');
        setState(() {
          isLoading = true;
        });
        ...
        print(
            'Found ${result.events.length} events, next batch: ${result.nextBatch}');
        setState(() {
          isLoading = false;
      ...
      case 1:
        ...
        print('Start search with batch $imagesNextBatch');
        final result = await room!.searchEvents(
          searchFunc: (event) => {
            MessageTypes.Image,
            MessageTypes.Video,
        ...
        print('Found ${result.events.length} events');
        setState(() {
          isLoading = false;
